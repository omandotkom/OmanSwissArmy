...
export default function JsonToCode() {
    ...
    const generateTypeScript = (obj: Record<string, JSONValue>, name: string = "Root"): string => {
        ...
        Object.entries(obj).forEach(([key, value]) => {
            if (typeof value === "object" && value !== null && !Array.isArray(value)) {
                output += generateTypeScript(value as Record<string, JSONValue>, capitalize(key));
            } else if (Array.isArray(value) && value.length > 0 && typeof value[0] === "object" && value[0] !== null && !Array.isArray(value[0])) {
                output += generateTypeScript(value[0] as Record<string, JSONValue>, capitalize(key));
            }
        });
    ...
    const generateGo = (obj: Record<string, JSONValue>, name: string = "AutoGenerated"): string => {
        ...
        Object.entries(obj).forEach(([key, value]) => {
            if (typeof value === "object" && value !== null && !Array.isArray(value)) {
                output += generateGo(value as Record<string, JSONValue>, capitalize(key));
            } else if (Array.isArray(value) && value.length > 0 && typeof value[0] === "object" && value[0] !== null && !Array.isArray(value[0])) {
                output += generateGo(value[0] as Record<string, JSONValue>, capitalize(key));
            }
        });
    ...
    const generateJava = (obj: Record<string, JSONValue>, name: string = "Root"): string => {
        ...
        Object.entries(obj).forEach(([key, value]) => {
            if (typeof value === "object" && value !== null && !Array.isArray(value)) {
                output += generateJava(value as Record<string, JSONValue>, capitalize(key));
            } else if (Array.isArray(value) && value.length > 0 && typeof value[0] === "object" && value[0] !== null && !Array.isArray(value[0])) {
                output += generateJava(value[0] as Record<string, JSONValue>, capitalize(key));
            }
        });

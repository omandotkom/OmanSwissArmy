...
export default function UrlEncoder() {
    ...
    const handleConvert = (text: string, currentMode: "encode" | "decode") => {
        ...
        trackActivity({ action: "URL_CONVERT", label: currentMode });
    };

    return (
        <div className="flex min-h-screen flex-col bg-zinc-950 p-6 font-sans text-zinc-100">
            <div className="mb-6 flex items-center justify-between">
                <h1 className="text-2xl font-light tracking-wide text-zinc-200">URL Encoder / Decoder</h1>
                <Link
                    href="/"
                    onClick={() => trackActivity({ action: "CLICK_BACK", label: "URL Encoder" })}

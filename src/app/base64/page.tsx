            ...
            <div className="flex flex-col gap-6 h-[80vh]">
                ...
                <div className="flex flex-col lg:flex-row gap-6 flex-1">
                    ...
                    <div className="flex flex-1 flex-col gap-2">
                        ...
                        <textarea
                            readOnly
                            className={`flex-1 w-full resize-none rounded-xl border border-zinc-800 bg-zinc-900 p-4 font-mono text-sm text-zinc-300 focus:outline-none focus:border-zinc-600 ${error ? "border-red-500/50 bg-red-900/10" : ""}`}

...
REM echo Copying 'bin' folder (OC Executable)...
REM xcopy /E /I /Y bin .next\standalone\bin >nul
...
if exist ".next\standalone\bin\oc.exe" (
    echo deleting oc binary...
    del /Q ".next\standalone\bin\oc.exe"
)
